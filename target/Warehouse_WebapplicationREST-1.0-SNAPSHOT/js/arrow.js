...
function myDrawFunction(source, target, check){
    ...
    // Koordinaten auf Zeichenfläche bezogen
    //jg.drawLine(coords[0] + coords[4] / 2, coords[1] + coords[5], coords[2] + coords[6] / 2, coords[3]);

    jg.drawLine(coords[0] + coords[4] / 2, coords[1] + coords[5], coords[0] + coords[4] / 2,
        (coords[1] + coords[5] + coords[3]) / 2);

    jg.drawLine(coords[0] + coords[4] / 2, (coords[1] + coords[5] + coords[3]) / 2, coords[2] + coords[6] / 2,
        (coords[1] + coords[5] + coords[3]) / 2);

    jg.drawLine(coords[2] + coords[6] / 2, (coords[1] + coords[5] + coords[3]) / 2,
